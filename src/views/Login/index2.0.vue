...
<!--            表单start-->
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="login-form" size="medium">
                ...
                <el-form-item  prop="code" class="item-form" minlength="6" maxlength="6">
                    <label>验证码</label>
                    <el-row :gutter="11">
...
<script>
    import {stripscript,validateEmail,validatePass,validatePasses,validateCode} from '@/utils/validate.js'
    export default {
        name: 'login',
        data() {
            //表单的数据
            ...
            //验证重复密码
            var validatePasswordes = (rule, value, callback) => {
                if (model === 'login') {
                    callback();
                }
                //过滤后的值
                ...
                } else if (validatePasses(value) != this.ruleForm.password) {
            ...
            return {
                ...
                rules: {
                    ...
                    passwords: [
                        {validator: validatePasswordes, trigger: 'blur'}
                    ],
                    code: [
